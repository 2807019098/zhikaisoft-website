      ...
      <div className="pt-[72px] pb-10">
        <div className="w-full max-w-[95%] lg:max-w-[90%] xl:max-w-[85%] mx-auto">
          ...
          <div className="bg-white rounded-xl shadow p-8 mt-8">
            ...
            <img
              src="https://picsum.photos/seed/web/900/300"
              alt="网站开发主图"
            ...
            <ul className="grid md:grid-cols-2 gap-6">
              <li className="bg-[#f0f6fa] rounded-lg p-6 text-center">
                ...
                <div className="text-gray-600 mb-2">数字化转型</div>
                <img
                  src="https://picsum.photos/seed/portal/200/120"
                  alt="企业门户"
              ...
              <li className="bg-[#f0f6fa] rounded-lg p-6 text-center">
                ...
                <div className="text-gray-600 mb-2">高转化设计</div>
                <img
                  src="https://picsum.photos/seed/marketingweb/200/120"
                  alt="营销型网站"
                  className="mx-auto rounded"
                />
              </li>
